...
import com.example.cammy.activity.CropImageActivity;
import com.example.cammy.activity.ImageEditor;
import com.example.cammy.activity.PreviewActivity;
import com.example.cammy.activity.RearrangeImages;
import com.example.cammy.adapter.EnhancementOptionsAdapter;
import com.example.cammy.database.DatabaseHelper;
import com.example.cammy.interfaces.OnItemClickListener;
import com.example.cammy.interfaces.OnPDFCreatedInterface;
import com.example.cammy.model.EnhancementOptionsEntity;
import com.example.cammy.model.ImageToPDFOptions;
import com.example.cammy.model.Watermark;
import com.example.cammy.util.Constants;
import com.example.cammy.util.CreatePdf;
import com.example.cammy.util.DialogUtils;
import com.example.cammy.util.FileUtils;
import com.example.cammy.util.ImageEnhancementOptionsUtils;
import com.example.cammy.util.ImageUtils;
import com.example.cammy.util.MorphButtonUtility;
import com.example.cammy.util.PageSizeUtils;
import com.example.cammy.util.PermissionsUtils;
import com.example.cammy.util.StringUtils;

import static com.example.cammy.util.Constants.AUTHORITY_APP;
import static com.example.cammy.util.Constants.DEFAULT_BORDER_WIDTH;
import static com.example.cammy.util.Constants.DEFAULT_COMPRESSION;
import static com.example.cammy.util.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static com.example.cammy.util.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static com.example.cammy.util.Constants.DEFAULT_PAGE_COLOR;
import static com.example.cammy.util.Constants.DEFAULT_PAGE_SIZE;
import static com.example.cammy.util.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static com.example.cammy.util.Constants.DEFAULT_QUALITY_VALUE;
import static com.example.cammy.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static com.example.cammy.util.Constants.MASTER_PWD_STRING;
import static com.example.cammy.util.Constants.OPEN_SELECT_IMAGES;
import static com.example.cammy.util.Constants.READ_WRITE_CAMERA_PERMISSIONS;
import static com.example.cammy.util.Constants.RESULT;
import static com.example.cammy.util.Constants.STORAGE_LOCATION;
import static com.example.cammy.util.Constants.appName;
import static com.example.cammy.util.WatermarkUtils.getStyleNameFromFont;
import static com.example.cammy.util.WatermarkUtils.getStyleValueFromName;

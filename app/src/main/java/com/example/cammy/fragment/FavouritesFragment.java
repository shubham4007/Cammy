package com.example.cammy.fragment;
...
import com.example.cammy.activity.FavouritesActivity;
import com.example.cammy.activity.MainActivity;
import com.example.cammy.customviews.MyCardView;
import com.example.cammy.fragment.texttopdf.TextToPdfFragment;
import com.example.cammy.model.HomePageItem;
import com.example.cammy.util.CommonCodeUtils;

import static com.example.cammy.util.Constants.ADD_IMAGES;
import static com.example.cammy.util.Constants.ADD_IMAGES_KEY;
import static com.example.cammy.util.Constants.ADD_PASSWORD_KEY;
import static com.example.cammy.util.Constants.ADD_PWD;
import static com.example.cammy.util.Constants.ADD_TEXT_KEY;
import static com.example.cammy.util.Constants.ADD_WATERMARK;
import static com.example.cammy.util.Constants.ADD_WATERMARK_KEY;
import static com.example.cammy.util.Constants.BUNDLE_DATA;
import static com.example.cammy.util.Constants.COMPRESS_PDF;
import static com.example.cammy.util.Constants.COMPRESS_PDF_KEY;
import static com.example.cammy.util.Constants.EXCEL_TO_PDF_KEY;
import static com.example.cammy.util.Constants.EXTRACT_IMAGES;
import static com.example.cammy.util.Constants.EXTRACT_IMAGES_KEY;
import static com.example.cammy.util.Constants.EXTRACT_TEXT_KEY;
import static com.example.cammy.util.Constants.HISTORY_KEY;
import static com.example.cammy.util.Constants.IMAGE_TO_PDF_KEY;
import static com.example.cammy.util.Constants.INVERT_PDF_KEY;
import static com.example.cammy.util.Constants.MERGE_PDF_KEY;
import static com.example.cammy.util.Constants.PDF_TO_IMAGES;
import static com.example.cammy.util.Constants.PDF_TO_IMAGES_KEY;
import static com.example.cammy.util.Constants.QR_BARCODE_KEY;
import static com.example.cammy.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static com.example.cammy.util.Constants.REMOVE_PAGES;
import static com.example.cammy.util.Constants.REMOVE_PAGES_KEY;
import static com.example.cammy.util.Constants.REMOVE_PASSWORD_KEY;
import static com.example.cammy.util.Constants.REMOVE_PWd;
import static com.example.cammy.util.Constants.REORDER_PAGES;
import static com.example.cammy.util.Constants.REORDER_PAGES_KEY;
import static com.example.cammy.util.Constants.ROTATE_PAGES;
import static com.example.cammy.util.Constants.ROTATE_PAGES_KEY;
import static com.example.cammy.util.Constants.SPLIT_PDF_KEY;
import static com.example.cammy.util.Constants.TEXT_TO_PDF_KEY;
import static com.example.cammy.util.Constants.VIEW_FILES_KEY;
import static com.example.cammy.util.Constants.ZIP_TO_PDF_KEY;

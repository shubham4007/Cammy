...
import com.example.cammy.adapter.RearrangePdfAdapter;
import com.example.cammy.util.Constants;
import com.example.cammy.util.DialogUtils;
import com.example.cammy.util.ThemeUtils;

import static com.example.cammy.util.Constants.CHOICE_REMOVE_IMAGE;
import static com.example.cammy.util.Constants.RESULT;
import static com.example.cammy.util.Constants.SAME_FILE;

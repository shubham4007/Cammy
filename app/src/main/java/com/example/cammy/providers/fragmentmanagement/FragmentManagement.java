package com.example.cammy.providers.fragmentmanagement;
...
import com.example.cammy.R;
import com.example.cammy.activity.WelcomeActivity;
import com.example.cammy.fragment.AboutUsFragment;
import com.example.cammy.fragment.AddImagesFragment;
import com.example.cammy.fragment.AddTextFragment;
import com.example.cammy.fragment.ExceltoPdfFragment;
import com.example.cammy.fragment.ExtractTextFragment;
import com.example.cammy.fragment.FAQFragment;
import com.example.cammy.fragment.FavouritesFragment;
import com.example.cammy.fragment.HistoryFragment;
import com.example.cammy.fragment.HomeFragment;
import com.example.cammy.fragment.ImageToPdfFragment;
import com.example.cammy.fragment.InvertPdfFragment;
import com.example.cammy.fragment.MergeFilesFragment;
import com.example.cammy.fragment.PdfToImageFragment;
import com.example.cammy.fragment.QrBarcodeScanFragment;
import com.example.cammy.fragment.RemoveDuplicatePagesFragment;
import com.example.cammy.fragment.RemovePagesFragment;
import com.example.cammy.fragment.SettingsFragment;
import com.example.cammy.fragment.SplitFilesFragment;
import com.example.cammy.fragment.ViewFilesFragment;
import com.example.cammy.fragment.ZipToPdfFragment;
import com.example.cammy.fragment.texttopdf.TextToPdfFragment;
import com.example.cammy.util.FeedbackUtils;
import com.example.cammy.util.FragmentUtils;
import com.example.cammy.util.WhatsNewUtils;
import com.google.android.material.navigation.NavigationView;

import static com.example.cammy.util.Constants.ACTION_MERGE_PDF;
import static com.example.cammy.util.Constants.ACTION_SELECT_IMAGES;
import static com.example.cammy.util.Constants.ACTION_TEXT_TO_PDF;
import static com.example.cammy.util.Constants.ACTION_VIEW_FILES;
import static com.example.cammy.util.Constants.ADD_IMAGES;
import static com.example.cammy.util.Constants.ADD_PWD;
import static com.example.cammy.util.Constants.ADD_WATERMARK;
import static com.example.cammy.util.Constants.BUNDLE_DATA;
import static com.example.cammy.util.Constants.COMPRESS_PDF;
import static com.example.cammy.util.Constants.EXTRACT_IMAGES;
import static com.example.cammy.util.Constants.OPEN_SELECT_IMAGES;
import static com.example.cammy.util.Constants.PDF_TO_IMAGES;
import static com.example.cammy.util.Constants.REMOVE_PAGES;
import static com.example.cammy.util.Constants.REMOVE_PWd;
import static com.example.cammy.util.Constants.REORDER_PAGES;
import static com.example.cammy.util.Constants.ROTATE_PAGES;
import static com.example.cammy.util.Constants.SHOW_WELCOME_ACT;
    ...
    public boolean handleNavigationItemSelected(int itemId) {
        ...
        switch (itemId) {
            ...
            case R.id.nav_rateus:
                mFeedbackUtils.openWebPage("https://play.google.com/store/apps/details?id=com.example.cammy");
                break;
